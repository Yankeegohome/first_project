...
class CategoryNews(ListView):
    ...
    template_name = 'news/home_news_list.html'
    context_object_name = 'news'
    allow_empty = False # Если страницы нет или она пуста он будет ее игнорить
    paginate_by = 2
...
class ViewNews(DetailView):
    ...
    #template_name = 'news/news_ditail.html'
...
class CreatedNews(LoginRequiredMixin, CreateView):
    form_class = NewsForm
